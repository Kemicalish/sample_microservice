defmodule SampleMicroservice.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import SampleMicroservice.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&SampleMicroservice.ErrorHelpers.translate_error/1)
